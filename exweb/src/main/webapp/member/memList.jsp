...
<body>                   		
<h1>회원목록</h1>
<%-- <button><a href="<%=request.getContextPath()%>/member/memAddform.jsp">회원추가</a></button> --%>
<button><a href="${pageContext.request.contextPath}/member/memAddform.jsp">회원추가</a></button>
<button><a href="<c:url value="/member/memAddform.jsp" />">회원추가</a></button>
